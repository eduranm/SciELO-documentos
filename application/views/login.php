            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form id="form" method="post" action="usuarios/iniciar_sesion_post" class="md-float-material">
                            <div class="text-center">
                                <img src="assets/images/scielomx.gif" alt="logo.png">
                            </div>
                            <div class="auth-box">
                                ...
                                <div class="input-group">
                                    <input id="contrasena" type="password" class="form-control" placeholder="Password" name="contrasena">
                                    <span class="md-line"></span>
                                </div>
                                <hr/>
...
<![endif]-->
    ...
    <script type="text/javascript" src="assets/js/md5/jquery.md5.js"></script>
